...
public class StatisticsCategoryController {
    ...
    private void loadCategoryStatistics() {
        try {
            ...
            request.setCommand("CATEGORY_STATISTICS");
    ...
    private void printChart() {
        try {
            ...
            WritableImage image = categoryPieChart.snapshot(new SnapshotParameters(), null);
            ...
            File pdfFile = fileChooser.showSaveDialog(categoryPieChart.getScene().getWindow());
            ...
            if (pdfFile != null) {
                ...
                Paragraph title = new Paragraph("Статистика по категориям", titleFont);
